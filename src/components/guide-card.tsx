...
export function GuideCard({ guide }: GuideCardProps) {
  return (
    <article className="rounded-[28px] border border-white/10 bg-white/[0.04] p-6 shadow-[0_18px_60px_rgba(4,10,24,0.28)] transition hover:-translate-y-1 hover:border-orange-300/40 hover:bg-white/[0.06]">
