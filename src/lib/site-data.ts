...
export const guides: Guide[] = [
  ...
  {
    slug: "codex-phone-verification-troubleshooting",
    title: "Codex 手机号验证卡住怎么办：安全排查与避坑指南",
    description: "遇到 Codex 登录手机号验证时，按官方入口、网络环境、浏览器状态、账号权限和短信验证逐项排查，避免使用接码、代验证和来路不明插件。",
    category: "FAQ",
    readingTime: "8 分钟",
    publishedAt: "2026-05-29",
    featured: true,
    source: {
      label: "参考讨论：Codex 手机号验证问题",
      url: "https://mp.weixin.qq.com/s/K7cCuIpSYbmIzYTnm-Tw-g",
    },
    sections: [
      {
        title: "先说明边界",
        body: [
          "网上会有一些“绕过手机号验证”的教程，但这类方法通常涉及接码平台、代验证、未知插件或账号共享，风险很高。对个人开发者来说，最稳妥的做法不是绕过验证，而是把官方登录流程跑通。",
          "这篇文章只讲安全排查：确认入口是否正确、账号是否可用、网络和浏览器是否影响验证、短信为什么收不到，以及验证完成后如何回到 Codex 桌面 App。"
        ],
        note: "不要把 ChatGPT / OpenAI 账号密码、验证码或登录二维码交给陌生人，也不要安装来路不明的“验证辅助插件”。"
      },
      {
        title: "按官方流程走一遍",
        body: [
          "先从官方入口开始：打开 chatgpt.com/codex/cloud，使用自己的 ChatGPT / OpenAI 账号登录。如果页面要求手机号验证，就按页面提示完成验证。",
          "完成验证后，再回到 Codex 桌面 App 或 Codex Cloud 页面继续下载、登录、选择项目。不要在多个来路不明页面之间来回跳转。"
        ],
        links: [
          {
            label: "打开 Codex Cloud 官方入口",
            url: "https://chatgpt.com/codex/cloud",
          },
        ],
        steps: [
          "打开官方入口，不从陌生短链进入。",
          "使用自己的 ChatGPT / OpenAI 账号登录。",
          "如果出现手机号验证，按页面提示完成。",
          "验证完成后回到 Codex 桌面 App 或 Cloud 页面继续操作。"
        ],
        image: {
          src: "/images/guides/codex-phone-verification/verification-flow.svg",
          alt: "Codex 手机号验证官方排查流程图",
          caption: "先把官方入口、账号登录、手机号验证和回到 App 这条主线跑通。"
        }
      },
      {
        title: "网络和地区问题",
        body: [
          "如果页面打不开、验证码区域加载不出来，或者登录后一直转圈，优先检查网络。很多时候不是手机号本身的问题，而是页面资源、验证码服务或登录回调没有正常加载。",
          "可以尝试切换更稳定的网络环境，关闭过度拦截的代理规则，或者换一个浏览器重新打开官方入口。"
        ],
        steps: [
          "确认 chatgpt.com 能正常打开。",
          "关闭会拦截脚本或验证码的浏览器扩展。",
          "切换稳定网络后重新登录。",
          "避免短时间内反复刷新和重复提交验证码。"
        ],
      },
      {
        title: "浏览器状态问题",
        body: [
          "手机号验证经常依赖浏览器会话、授权回调和脚本加载。如果你之前登录过多个账号，或者浏览器装了很多拦截类插件，就可能出现页面不跳转、按钮无反应、验证码不显示的问题。",
          "这时可以换一个干净的浏览器窗口，或者使用无痕窗口重新登录。确认验证完成后，再回到 Codex 桌面 App。"
        ],
        steps: [
          "关闭广告拦截、脚本拦截、隐私增强类扩展后重试。",
          "退出错误账号，确认当前登录的是你要使用 Codex 的账号。",
          "必要时使用无痕窗口重新打开官方入口。",
          "验证完成后再打开桌面 App，不要同时混用多个账号。"
        ],
      },
      {
        title: "短信收不到怎么办",
        body: [
          "短信收不到时，先检查号码格式、国家或地区代码、手机是否拦截国际短信，以及是否短时间内请求太多次。频繁重试可能触发更严格的限制。",
          "如果确认号码和网络都没问题，可以等待一段时间再试。仍然失败时，优先联系官方支持，而不是把账号交给所谓代验证服务。"
        ],
        steps: [
          "确认国家或地区代码选择正确。",
          "检查手机短信拦截、垃圾短信和运营商限制。",
        ...
        image: {
          src: "/images/guides/codex-phone-verification/troubleshooting-checklist.svg",
          alt: "Codex 手机号验证失败排查清单",
          caption: "验证失败时按网络、浏览器、账号、短信和安全风险逐项排查。"
        }
      },
      {
        title: "不要碰这些高风险方法",
        body: [
          "接码平台、代验证、共享账号、未知插件和远程协助登录都不建议使用。它们可能导致账号被盗、隐私泄露、风控升级，甚至账号被封。",
          "看起来省事的方法，后面往往会带来更高成本。尤其是开发工具账号通常绑定项目、代码、账单和个人身份，安全性要放在第一位。"
        ],
        steps: [
          "不要把账号密码发给别人。",
          "不要把验证码、登录二维码或授权链接发给别人。",
          "不要安装来源不明的浏览器插件。",
          "不要使用接码平台或代验证服务。",
          "不要在公共设备上保存登录状态。"
        ],
      },
      {
        title: "验证完成后回到 Codex",
        body: [
          "验证通过后，重新打开 Codex 桌面 App。正常情况下，App 会识别你的登录状态，或者提示你重新授权一次。",
          "如果桌面 App 仍然停留在登录前状态，可以退出 App 后重新打开；如果仍不行，再回到浏览器确认 ChatGPT / OpenAI 账号已经处于登录状态。"
        ],
        steps: [
          "关闭并重新打开 Codex 桌面 App。",
          "确认浏览器里的 ChatGPT / OpenAI 账号仍然登录。",
          "按 App 提示完成授权回跳。",
          "进入 Projects 或 Chats 后，再开始第一个小任务。"
        ],
      },
    ],
  },
